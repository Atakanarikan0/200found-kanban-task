        ...
        <div className="sidebar">
          ...
          <div className="sidebar-content">
            ...
            {boards?.map(x => (
              <div key={x?.id}>
                <button 
                  onClick={() => setSelectedBoardId(x?.id)}
                  className={selectedBoardId === x?.id ? 'active' : ''}
                  >
            ...
            <button className="add-board" onClick={() => { addRef.current.showModal() }}><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
